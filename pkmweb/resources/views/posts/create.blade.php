...
<div id="content-wrapper">
    ...
    <?php
      ...
      ?>
    <a href="{{ url('home') }}"><i class="fas fa-chevron-circle-left"></i> Kembali</a>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('posts.store') }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control-sm form-control selectpicker" name="bank" data-live-search="true"
                            required>
                            @foreach ($bank as $banks)
                            <option value="<?php echo $banks['label']; ?>"><?php echo $banks['label']; ?></option>
                            @endforeach
                        </select>
                    </div>
                </div>
